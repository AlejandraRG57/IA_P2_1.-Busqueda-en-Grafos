...
#La búsqueda de vuelta atrás es un algoritmo de búsqueda que se utiliza para encontrar soluciones a problemas de satisfacción de restricciones. 
#Funciona de manera similar a la exploración de un árbol, pero utiliza una estrategia de retroceso (backtracking) para deshacerse de las soluciones 
#parciales que no cumplen con ciertas restricciones y volver a un estado anterior para probar una solución alternativa.
